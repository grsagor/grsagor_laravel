@php
    ...
    $pageDescription = 'Get in touch with Golam Rahman Sagor for web development projects, consultations, or collaborations.';
@endphp
...
@section('content')
<section class="contact-section py-5" style="padding-top: 8rem;">
  <div class="container">
