<nav class="sb-topnav navbar navbar-expand navbar-dark">
    <a class="navbar-brand text-center ps-3" target="_blank" href="">
        <img class="backend-nav-logo" src="{{ Helper::getSettings('site_logo') ? asset(Helper::getSettings('site_logo')) : asset('assets-bk/img/Logo.png')}}" alt="Logo">
    </a>
                ...
                <div class="admin-profile">
                    <div class="dropdown">
                        <a href="#" class="topimage" id="navbarDropdown" role="button" aria-expanded="false">
                            <img class="profile-img"  src="{{ Auth::user()->profile_image ? asset(Auth::user()->profile_image) : asset('assets-bk/utils/images/no-img.jpg') }}" alt="profile image">
                        </a>
